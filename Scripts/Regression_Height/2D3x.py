...
with strategy.scope():
    base_model = prepare_model_without_output(input_shape=(300, 100, 3))  # Shared base model
...
for rep in range(1, 51):  # Run repetitions
    ...
    with strategy.scope():
        ...
        if R2 > best_r2 or RMSE < best_rmse:
            best_r2 = R2
            best_rmse = RMSE
            best_model_path = '/gpfs/fs7/aafc/phenocart/PhenomicsProjects/UFPSGPSCProject/6_Output/5_Final Results/2024/Best_2D3x_HeightEstimation_Model.h5'
